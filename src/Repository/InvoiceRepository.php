...
//     */
    ...
    public function findAllInvoicesByCompany($company)
    {
        ...
        $query = $em->createQuery(
             "SELECT DATE_FORMAT(i.date, '%Y-%m-%d') as date, i.id, i.reference, i.amount_all_taxes, i.amount_dutty_free, i.paid, DATE_FORMAT(i.deadline1, '%Y-%m-%d') as deadline1, cu.id, cu.lastname, cu.firstname, cu.company_name, s.invoice_status
