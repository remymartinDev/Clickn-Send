 ...
 */
final class Version20180702113136 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, company_name VARCHAR(255) NOT NULL, company_adress VARCHAR(255) NOT NULL, phone VARCHAR(30) DEFAULT NULL, fax VARCHAR(30) DEFAULT NULL, vat_number VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, bank_info VARCHAR(255) NOT NULL, bank_iban VARCHAR(30) NOT NULL, bank_bic VARCHAR(8) NOT NULL, bank_rib VARCHAR(23) NOT NULL, bank_domiciliation VARCHAR(255) NOT NULL, payment_term VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
