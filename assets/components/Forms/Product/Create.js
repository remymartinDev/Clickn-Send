...
let CreateProduct = props => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      ...
      <Field className="form-field" name="denomination" component="input" type="text" required />
      ...
      <Field className="form-field" name="price" component="input" type="number" required />
      <label className="form-label" htmlFor="unity">Unité*</label>
      <Field className="form-field" name="unity" component="input" type="text"  required />
